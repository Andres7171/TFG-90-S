          ...
          >
            ...
            {success ? (
              <div className="cart-success">
                <p className="cart-success-text">¡Pedido realizado con éxito!</p>
              ...
              <>
                ...
                {items.length > 0 && (
                  <div className="cart-footer">
                    ...
                    >
                      {checkingOut ? 'PROCESANDO...' : showAddress ? 'CONFIRMAR PEDIDO' : 'FINALIZAR COMPRA'}
                    </button>
                  </div>
                )}
              </>
